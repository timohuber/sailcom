...
class Boat(models.Model):
    ...
    detail_description = models.CharField(max_length=3000, blank=True, null=True)
    technical_description = models.CharField(max_length=3000, blank=True, null=True)
    ...
    motor_brand = models.CharField(max_length=50, blank=True, null=True)
