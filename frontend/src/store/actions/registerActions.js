import { baseUrl, VERIFICATION_CODE_REQUESTED, VERIFICATION_CONFIRMED, UPDATE_CURRENT_USER } from '../constants'
...
export const userValidationConfirmed = () => {
    return {
...
export const userValidationConfirmedAction = () => (dispatch, getState) => {
    dispatch(userValidationConfirmed())
}
