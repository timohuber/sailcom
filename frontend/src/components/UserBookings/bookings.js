...
import {dateFromBackendToDisplayString, dateToISOString} from "../../lib/helpers/formatDates";
...
export default function BookingElement(props) {
    ...
    return (
            <div className='user-bookings-list-element'>
                ...
                {
                    dateToISOString(moment(today)) > dateToISOString(moment(booking.from_date_time).add(-2, 'hours'))
                    ? null
