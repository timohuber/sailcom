...
import { getMembershipTypesAction } from '../../store/actions/miscActions';
...
function UserEditMembership(props) {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            document.getElementById('membership-form-success').innerText =
                'Die Mitgliedschaft wurde erfolgreich angepasst';
        } catch (error) {
            ...
            {loading ? (
                ...
                <>
                    ...
                    {user.membership_type ? (
                        ...
                        <p className='success'>
                            {user.first_name} {user.last_name} hat eine
                            Mitgliedschaft beantragt
                        </p>
                    ) : (
                        <p className='error'>
                            {user.first_name} {user.last_name} hat noch keine
                            Mitgliedschaft beantragt
                        </p>
                    )}
                    <form onSubmit={(e) => onSubmitHandler(e)}>
                        ...
                        <button tpe='submit' className='btn primary'>
                            Bestätigen
                        </button>
                    </form>
                </>
